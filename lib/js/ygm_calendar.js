...
// 다시하세요
// 선택 일로부터 일주일이 아닌 선택한 일이 포함된 주를 조회 하는 함수입니다.
// 20년 2월 기준 13일을 입력시
// 9일 ~ 15일 이 조회 되어야 합니다.
function getWeek (date) {
 ...
 //해당 일이 함 된 월 조회 함수
 // 처음 인자값으로 date를 스트링 형태의 "2020-02-13" 을 넣을경우 +1 이 필요 없습니다.
 // ex) 
 //     getMonth("2020-02-13");
 //     var monthLastDay = new Date(dateStr).format("dd");
